...
interface fightClassProps {}

export const fightClass: React.FC<fightClassProps> = ({}) => {
	...
	return (
		<CustomModal open={true} title='Fight Class' close={closed}>
			<Text style={styles.topics}>Fight Types</Text>
			<DropDownPicker
				style={styles.picker}
				open={openPicker}
				value={value}
